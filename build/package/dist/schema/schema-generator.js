...
class SchemaGenerator {
        ...
        this.interfaceTypesInfo = getMetadataStorage_1.getMetadataStorage().interfaceTypes.map(interfaceType => {
            ...
            return {
                ...
                type: new graphql_1.GraphQLInterfaceType({
                    ...
                    astNode: definition_node_1.getInterfaceTypeDefinitionNode(interfaceType.name, interfaceType.directives),
                    interfaces: () => {
    ...
    static generateSubscriptionsFields(subscriptionsHandlers) {
        ...
        return subscriptionsHandlers.reduce((fields, handler) => {
            ...
            fields[handler.schemaName].subscribe = create_1.wrapResolverWithAuthChecker(subscribeFn, container, handler.roles);
            return fields;
        }, basicFields);
    }
